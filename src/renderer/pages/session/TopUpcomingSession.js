...
const TopUpcomingSession=()=>{
        ...
        const getUpcomingSessions = (() => {
                window.require("electron").ipcRenderer.send("getTopUpcomingSessions",{});
    
                window.require("electron").ipcRenderer.on("getTopUpcomingSessions", (e,data) => {
        ...
        <div className='col' style={{'paddingLeft':'0%','paddingRight':'0%'}}>
                {/* <div>
                        {       paradigms && paradigms?.trials && (
                                paradigms?.trials[1]?.url)
                        }
                </div> */}
                ...
                <div className='row'> 
                        <div>
                                <Modal size="lg" show={showBci} onHide={handleBciClose} centered>
...
export default TopUpcomingSession;